...
if __name__ == "__main__":
    ...
    while prog: 
        ...
        selection=input("Please Select (number): ") 
        sub=True
        if selection =='1':
            while sub:
            ...
            while sub:
                ...
                winds_ON=input("winds_ON [True/False]: ")
                emp_ON=input("emp_ON[True/False]: ")
                heat_ON=input("heat_ON[True/False]: ")
                drag_ON=input("drag_ON[True/False]: ")
                if winds_ON=="1":
                    winds_ON=True
                else:
                    winds_ON=False  
